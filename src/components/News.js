...
const News = ({ simplified }) => {
    ...
    const demoImage = "https://image.cnbcfm.com/api/v1/image/106984655-1638720074358-gettyimages-1294303237-01_jan_01_005.jpeg?v=1641825196&w=929&h=523";
                ...
                <Row gutter={[24, 24]}>
                    {
                        !simplified && (
                            <Col span={24}>
                                ...
                                >
                                    <Option value="Cryptocurrency">Digital Currency</Option>
                                    {
